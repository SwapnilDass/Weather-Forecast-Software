...
public class WeatherApp {
    //fetch weather data from the given location 
    public static JSONObject getWeatherData (String locationName){
        ...
        try{
            ...
            if (conn.getResponseCode() != 200){
                System.out.println("Error: Could not connrct to API");
                return null;
            }
            ...
            //build the weather json data object that we are going to access in out frontend
